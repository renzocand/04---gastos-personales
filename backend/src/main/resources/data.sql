...
INSERT INTO category (id, name, icon, description, sort_order) VALUES
    ...
    ('housing',   'Vivienda',          'Home',            'Alquiler, hipoteca y mantenimiento estructural de tu casa.',                3),
    ...
    ('shopping',  'Compras personales','ShoppingBag',     'Ropa, calzado, accesorios, tecnología y cuidado personal.',                 8),
    ('home',      'Hogar',             'Sparkles',        'Limpieza, artículos de cocina, electrodomésticos menores y decoración.',    9),
    ('other',     'Otro',              'Package',         'Gastos que no encajan en las demás categorías.',                           10) AS new
